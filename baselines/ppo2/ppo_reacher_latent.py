...
meta_path = '/scr/kevin/unsupervised_upn/summ/reacher_50k_latent_planning_ol_lr0.005_il_lr0.25_num_plan_updates_15_horizon_1_num_train_45000__learn_lr_13-10-2018_16-25-14/models/model_test_99500.meta'
...
def train(num_timesteps, seed, load_path=None, itr = 1, simulate = False, render = False, vision=True):
	...
	def make_env():
		baseEnv = ReacherVisionEnv(vision=vision, use_latent=True, latent_meta_path=meta_path)
...
N = 1e7 ; simItr = 750
expName = 'reacher_latent_control5_bs_64_ctrl_eps_100_lam0.97'#_random_arm_color_lighting'#_handinit' #simItr=930 #1170 #1260 #1400 #1510 #4010
